...
* [&lt;sfn/functional.h&gt;](#sfnfunctionalh)
   * [Basics](#basics)
   * [`sfn::unwrap`](#sfnunwrap)
   * [`sfn::sequence`](#sfnsequence)
   * [`sfn::cast`](#sfncast)
   * [`sfn::reinterpret`](#sfnreinterpret)
   * [`sfn::bind_front` and `sfn::bind_back`](#sfnbind_front-and-sfnb_indback)
   * [`sfn::compose_front` and `sfn::compose_back`](#sfncompose_front-and-sfn_composeback)
   * [Notes](#notes)
* [&lt;sfn/type_list.h&gt;](#sfntype_listh)
   * [`sfn::list`](#sfnlist)
